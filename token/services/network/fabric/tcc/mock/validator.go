...
func (fake *Validator) VerifySideBizContext(ctx context.Context, stub shim.ChaincodeStubInterface, anchor string, raw []byte, ccArgs [][]byte, ccTArgs map[string][]byte,) error {
	return nil
}
