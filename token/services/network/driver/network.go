...
type Network interface {
	...
	RequestApproval(context view.Context, tms *token2.ManagementService, requestRaw []byte, signer view.Identity, txID TxID, sbParamsContext []byte, sbTransientContext []byte) (Envelope, error)
